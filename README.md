...
- **[harvis.dev](https://github.com/harvis-io/harvis-dev-mcp)** - Deploy static sites straight from your AI client with [harvis.dev](https://harvis.dev): a remote MCP server with a deploy_site tool that publishes files and returns a live URL, no account or API key needed.
