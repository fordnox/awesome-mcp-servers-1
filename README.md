...
- **[harvis.dev](https://harvis.dev)** - Deploy static sites straight from your AI client: a remote MCP server with a deploy_site tool that publishes files and returns a live URL, no account or API key needed.
